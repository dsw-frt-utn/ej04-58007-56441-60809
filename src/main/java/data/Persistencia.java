...
public class Persistencia {
    ...
    private static void inicializarVehiculos(){
        ...
        VehiculoElectrico v1 = new VehiculoElectrico("AE123FG", new Marca("Renault", "Brasil"), "Kangoo E-Tech", 2020, 1000, s1, 16);
        VehiculoElectrico v2 = new VehiculoElectrico("AF456HI", new Marca("Ford", "EEUU"), "E-Transit", 2021, 1300, s2, 16);

        VehiculoCombustible v3 = new VehiculoCombustible("AC789JK", new Marca("Iveco","Argentina"), "Daily", 2023, 1200, s1, 8, 1.5);
